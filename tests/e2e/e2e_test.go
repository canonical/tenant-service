...
func TestHTTPAuthentication(t *testing.T) {
	...
	t.Run("Request Without Auth Should Fail", func(t *testing.T) {
		...
		resp, err := client.TenantServiceListTenants(ctx, &httpclient.TenantServiceListTenantsParams{})
		if err != nil {
	...
	t.Run("Request With Valid Auth Should Succeed", func(t *testing.T) {
		...
		resp, err := client.TenantServiceListTenants(ctx, &httpclient.TenantServiceListTenantsParams{}, authEditor)
		if err != nil {
