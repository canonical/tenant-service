...
func TestService_ListTenantsByUserID(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			tenants, _, err := s.ListTenantsByUserID(context.Background(), userID, types.ListOptions{})
...
func TestService_ListTenants(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			tenants, _, err := s.ListTenants(context.Background(), types.ListOptions{})
...
func TestService_ListUserTenants(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			tenants, _, err := s.ListUserTenants(context.Background(), userID, types.ListOptions{})
...
func TestService_ListTenantUsers(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			users, _, err := s.ListTenantUsers(context.Background(), tenantID, types.ListOptions{})
