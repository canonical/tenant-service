...
//go:generate mockgen -build_flags=--mod=mod -package tenant -destination ./mock_handlers.go -source=./interfaces.go ServiceInterface
//go:generate mockgen -build_flags=--mod=mod -package tenant -destination ./mock_handlers_logger.go -source=../../internal/logging/interfaces.go
