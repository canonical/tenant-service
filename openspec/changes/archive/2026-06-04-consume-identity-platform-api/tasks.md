...
- [x] 6.3 TODO: remove temporary `generate-http-client` make target once upstream publishes a consumable HTTP client library, and switch imports to that upstream package
