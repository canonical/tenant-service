...
- [x] 4.1-cves-monitoring Add scheduled workflow or job in [.github/workflows/cves.yaml](.github/workflows/cves.yaml) to run periodic Trivy scans against `ghcr.io/canonical/tenant-service:stable`
...
- [x] 6.2-verify-test-unit Run `make test` locally and ensure it exits with zero diagnostic failures
